...
<html lang="en">
    ...
    <body class="sb-nav-fixed"> 
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-info ">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index.html">Aplikasi E-Ticket</a>
            <!-- Sidebar Toggle-->
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="?page=log_payment">
                                <div class="sb-nav-link-icon"><i class="fas fa-book"></i></div>
                                Log Payment
                            </a>
                            ...
                            <a class="nav-link" href="?page=penumpang">
                                <div class="sb-nav-link-icon"><i class="fas fa-book"></i></div>
                                Penumpang
                            </a>
                            <a class="nav-link" href="logout.php">
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">&copy; Copyright Aplikasi E-Ticket 2025</div>
